...
const pages = [
  {
    destination: '/docs/aragon-cli/cli-intro.md',
    id: 'cli-intro',
  ...
  {
    destination: '/docs/aragon-cli/cli-main-commands.md',
  ...
  {
    destination: '/docs/aragon-cli/cli-apm-commands.md',
    id: 'cli-apm-commands',
  ...
  {
    destination: '/docs/aragon-cli/cli-dao-commands.md',
    id: 'cli-dao-commands',
    title: 'DAO commands',
  ...
  {
    destination: '/docs/aragon-cli/cli-ipfs-commands.md',
  ...
  {
    destination: '/docs/aragon-cli/cli-global-confg.md',
    id: 'cli-global-confg',
