...
If you're having trouble with this step, look at the installing aragonCLI section of our [FAQ](/docs/faq/cli-install.md). If that doesn't fix things, please don't hesitate to reach out to us at the [#dev-help channel on the Aragon Chat](https://aragon.chat/channel/dev-help).
