...
sidebar_label: aragonOS reference
hide_title: true
---
...
_Looking for [aragonOS 3 documentation?](/docs/advanced/os-3-ref.md)_

<br>

This document provides a technical overview of the framework's architecture and provides insight into its capabilities. It assumes the reader understands [Solidity](https://solidity.readthedocs.io/). For a less technical introduction, visit the [introduction](/docs/basics/basics-os-concepts.md).
...
> **Note**
>
> We have outlined a number of recommended conventions to follow in the [aragonOS development guide](/docs/advanced/os-building.md#conventions).
...
![](/docs/assets/advanced/app-lifecycle.svg)
