...
This module allows to interact with aragonAPI using [React Hooks](https://reactjs.org/docs/hooks-intro.html). [`@aragon/api`](https://github.com/aragon/aragon.js/blob/master/docs/aragonjs-ref-app.html) is used under the hood, so being familiar with it can be useful.
...
This is the current [`AragonApp`](https://github.com/aragon/aragon.js/blob/master/docs/aragonjs-ref-app.html#aragonapp) instance. Use it to call methods on the contract.
...
An [object](https://github.com/aragon/aragon.js/blob/master/docs/aragonjs-ref-app.html#network) representing the current network using its `id` and `type` entries. Its value is `null` until it gets loaded.
