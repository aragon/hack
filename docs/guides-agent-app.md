...
Note that, same as before, this command will trigger a vote in the DAO and **you'll need to vote _yes_ to confirm the new permissions you've granted the Voting app.**
...
## Use case: Voting in another organization
