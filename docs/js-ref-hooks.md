...
This module allows to interact with aragonJS using [React Hooks](https://reactjs.org/docs/hooks-intro.html). [`@aragon/api`](https://github.com/aragon/aragon.js/blob/master/docs/aragonjs-ref-app.html) is used under the hood, so being familiar with it can be useful.
